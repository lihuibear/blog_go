...
// SentenceTagColumns defines and stores column names for the table sentence_tag.
type SentenceTagColumns struct {
	SId string // 句子id
	TId string // tag id
}

// sentenceTagColumns holds the columns for the table sentence_tag.
...
func NewSentenceTagDao(handlers ...gdb.ModelHandler) *SentenceTagDao {
